class InstallSearchjoy < ActiveRecord::Migration[5.1]
  def change
    ...
    add_index :searchjoy_searches, [:convertable_id, :convertable_type], name: "index_searchjoy_searches_on_convertible_id_type" # autogenerated name is too long
  end
end
